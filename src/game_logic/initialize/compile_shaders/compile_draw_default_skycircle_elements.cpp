...
{
	void compile_draw_default_skycircle_elements
	(
	...
	)
	{
		...
		(
			...
			::util::shader::file_to_string("draw/skycircle_elements/default/draw.vert")
		);
		...
		(
			...
			compile_environment.readonly_prefix_source,
			::util::shader::file_to_string("draw/skycircle_elements/default/draw.frag")
		);

		environment.state.shaders[static_cast<GLuint>(::game_state::shader_indices::draw::entities::skycircle_elements::Indices::default_elements)] = ::util::shader::create_program
		(

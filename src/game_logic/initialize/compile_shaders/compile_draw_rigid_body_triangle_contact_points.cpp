...
{
	void compile_draw_rigid_body_triangle_contact_points
	(
	...
	)
	{
		...
		(
			...
			::util::shader::file_to_string("draw/constraints/rigid_body_triangle_contacts/contact_points/draw.vert")
		);
		...
		(
			...
			compile_environment.readonly_prefix_source,
			::util::shader::file_to_string("draw/constraints/rigid_body_triangle_contacts/contact_points/draw.frag")
		);

		environment.state.shaders[static_cast<GLuint>(::game_state::shader_indices::draw::entities::constraints::Indices::rigid_body_triangle_contact_points)] = ::util::shader::create_program
		(

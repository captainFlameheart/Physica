...
{
	void compile_draw_point_mass_forces
	(
	...
	)
	{
		...
		(
			...
			::util::shader::file_to_string("draw/bodies/point_masses/forces/draw.vert")
		);
		...
		(
			...
			compile_environment.readonly_prefix_source,
			::util::shader::file_to_string("draw/bodies/point_masses/forces/draw.frag")
		);

		environment.state.shaders[static_cast<GLuint>(::game_state::shader_indices::draw::entities::bodies::Indices::point_mass_forces)] = ::util::shader::create_program
		(

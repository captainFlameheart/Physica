...
{
	void compile_draw_world_border
	(
	...
	)
	{
		...
		(
			...
			::util::shader::file_to_string("draw/world_border/world_border.vert")
		);
		...
		(
			...
			compile_environment.readonly_prefix_source,
			::util::shader::file_to_string("draw/world_border/world_border.frag")
		);

		environment.state.shaders[static_cast<GLuint>(::game_state::shader_indices::draw::world_border::Indices::world_border)] = ::util::shader::create_program
		(

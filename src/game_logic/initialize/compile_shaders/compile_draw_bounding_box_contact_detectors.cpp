...
{
	void compile_draw_bounding_box_contact_detectors
	(
	...
	)
	{
		...
		(
			...
			::util::shader::file_to_string("draw/constraint_spawners/bounding_box_contact_detectors/default/draw.vert")
		);
		...
		(
			...
			compile_environment.readonly_prefix_source,
			::util::shader::file_to_string("draw/constraint_spawners/bounding_box_contact_detectors/default/draw.frag")
		);

		environment.state.shaders[static_cast<GLuint>(::game_state::shader_indices::draw::entities::constraint_spawners::Indices::bounding_box_contact_detectors)] = ::util::shader::create_program
		(

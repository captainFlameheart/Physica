...
{
	void compile_draw_rigid_body_circle_contact_constraint_spawners
	(
	...
	)
	{
		...
		(
			...
			::util::shader::file_to_string("draw/constraint_spawners/rigid_body_circle_contact_constraint_spawners/default/draw.vert")
		);
		...
		(
			...
			compile_environment.readonly_prefix_source,
			::util::shader::file_to_string("draw/constraint_spawners/rigid_body_circle_contact_constraint_spawners/default/draw.frag")
		);

		environment.state.shaders[static_cast<GLuint>(::game_state::shader_indices::draw::entities::constraint_spawners::Indices::rigid_body_circle_contact_constraint_spawners)] = ::util::shader::create_program
		(

...
{
	void compile_clear_rigid_body_triangle_contact_deaths
	(
	...
	)
	{
		...
		(
			...
			::util::shader::file_to_string("tick/pre_constraints/clear_deaths/clear_rigid_body_triangle_contact_deaths.comp")
		);

		environment.state.shaders[static_cast<GLuint>(::game_state::shader_indices::tick::process_entities::pre_constraints::clear_deaths::Indices::clear_rigid_body_triangle_contact_deaths)] = ::util::shader::create_program
		(
			compile_environment.shader_group.compute_shader
		);
	}

...
namespace game_logic::initialize::compile_shaders::environment
{
	...
	)
	{
		...
		constexpr GLuint entity_type_count = 3u;
		constexpr GLuint dispatch_command_count = 3u;
		constexpr GLuint draw_arrays_command_count = 3u;
		...
		compile_environment.constant_definitions = 
			"const uint entity_type_count = " + std::to_string(entity_type_count) + ";\n"
			"const uint dispatch_command_count = " + std::to_string(dispatch_command_count) + ";\n"
			"const uint draw_arrays_command_count = " + std::to_string(draw_arrays_command_count) + ";\n"

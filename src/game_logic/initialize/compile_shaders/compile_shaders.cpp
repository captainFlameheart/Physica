...
namespace game_logic::initialize::compile_shaders
{
	void compile_shaders(game_environment::Environment& environment)
	{
		...
		compile_set_clear_invalid_contact_commands(environment, compile_environment);

		compile_clear_invalid_rigid_body_circle_contact_detectors(environment, compile_environment);
		compile_clear_invalid_rigid_body_circle_contacts(environment, compile_environment);

		compile_initialize(environment, compile_environment);
		
		compile_on_key_event(environment, compile_environment);
		compile_on_mouse_button_event(environment, compile_environment);
		compile_on_scroll_event(environment, compile_environment);
		...
		compile_tick_default_skycircle_elements(environment, compile_environment);
		...
		compile_clear_rigid_body_triangle_contact_detector_deaths(environment, compile_environment);
		...
		compile_clear_rigid_body_triangle_contact_deaths(environment, compile_environment);
		...
		compile_draw_rigid_body_triangle_contact_detectors(environment, compile_environment);
		...
		compile_draw_timing_deadline(environment, compile_environment);

...
{
	void compile_on_mouse_button_event
	(
	...
	)
	{
		...
		(
			...
			::util::shader::file_to_string("blocks/uniform/Mouse_Button_Event"),
			::util::shader::file_to_string("on_mouse_button_event/on_mouse_button_event.comp")
		);

		environment.state.shaders[static_cast<GLuint>(::game_state::shader_indices::on_mouse_button_event::Indices::on_mouse_button_event)] = ::util::shader::create_program
		(
			compile_environment.shader_group.compute_shader
		);
	}

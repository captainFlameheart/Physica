...
{
	void compile_draw_rigid_body_triangle_bounding_boxes
	(
	...
	)
	{
		...
		(
			...
			::util::shader::file_to_string("draw/bounding_volume_hierarchy/rigid_body_triangle_bounding_boxes/default/draw.vert")
		);
		...
		(
			...
			compile_environment.readonly_prefix_source,
			::util::shader::file_to_string("draw/bounding_volume_hierarchy/rigid_body_triangle_bounding_boxes/default/draw.frag")
		);

		environment.state.shaders[static_cast<GLuint>(::game_state::shader_indices::draw::entities::bounding_volume_hierarchy::Indices::rigid_body_triangle_bounding_boxes)] = ::util::shader::create_program
		(

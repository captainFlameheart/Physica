...
GLuint util::shader::create_shader(GLenum type)
{
	return glCreateShader(type);
}

void util::shader::set_shader(
	GLuint const shader,
	GLsizei const count,
...
GLuint util::shader::create_program()
{
	return glCreateProgram();
}

void util::shader::delete_shader(GLuint const shader)
{
	glDeleteShader(shader);
}

void util::shader::delete_program(GLuint const program)
{

...
namespace game_state::units
{
	...
	constexpr GLfloat frames_per_second = 60.0f;
	constexpr GLfloat ticks_per_frame = 1.0f;

	constexpr GLfloat second_in_time_units{ ticks_per_frame * frames_per_second };

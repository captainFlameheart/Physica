...
namespace game_state::draw_primitive_types
{
	...
	constexpr std::array<GLenum, ::game_state::shader_indices::draw::entities::count> initialize_entities_primitive_types()
	{
		...
		primitive_types[static_cast<GLuint>(::game_state::shader_indices::draw::entities::constraint_spawners::Indices::rigid_body_triangle_contact_detectors) - base] = default_primitive_type;
		...
		primitive_types[static_cast<GLuint>(::game_state::shader_indices::draw::entities::constraints::Indices::rigid_body_triangle_contact_points) - base] = default_primitive_type;

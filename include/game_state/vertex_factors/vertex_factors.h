...
namespace game_state::vertex_factors
{
	constexpr std::array<GLuint, ::game_state::shader_indices::draw::entities::count> initialize_draw_entities_vertex_factors()
	{
		...
		vertex_factors[static_cast<GLuint>(::game_state::shader_indices::draw::entities::constraint_spawners::Indices::rigid_body_triangle_contact_detectors) - base] = 6u;
		...
		vertex_factors[static_cast<GLuint>(::game_state::shader_indices::draw::entities::constraints::Indices::rigid_body_triangle_contact_points) - base] = 12u;
		vertex_factors[static_cast<GLuint>(::game_state::shader_indices::draw::entities::constraints::Indices::rigid_body_circle_contact_constraint_contact_points) - base] = 6u;

		vertex_factors[static_cast<GLuint>(::game_state::shader_indices::draw::entities::bounding_volume_hierarchy::Indices::rigid_body_triangle_bounding_boxes) - base] = 6u;

...
namespace legacy::game_state
{
	...
	struct Game
	{
		...
		::game_state::OpenGL_capabilities::State OpenGL_capabilities;
		...
		GLuint draw_sky_circle_test_element_shader_color_uniform_location;
		...
		GLint holographic_probe_grid_draw_shader_source_size_uniform_location;
		GLint holographic_probe_grid_draw_shader_probe_padding_factor_uniform_location;

		GLuint holographic_probe_points_draw_shader;
		GLint holographic_probe_points_draw_shader_probe_grid_size_uniform_location;
		...
		union
		{
			struct
			{
				GLuint holographic_cascade_fluence_single_cone_draw_shader_showcased_cone_texel_x;
				GLuint holographic_cascade_fluence_single_cone_draw_shader_showcased_cone_texel_y;
			};
		...
		union
		{
			struct
			{
				GLuint holographic_cascade_rays_single_ray_draw_shader_showcased_ray_texel_x;
				GLuint holographic_cascade_rays_single_ray_draw_shader_showcased_ray_texel_y;
			};
		...
		union
		{
			struct
			{
				GLuint holographic_cascade_rays_merge_to_cone_draw_shader_merged_to_cone_texel_x;
				GLuint holographic_cascade_rays_merge_to_cone_draw_shader_merged_to_cone_texel_y;
			};
		...
		union
		{
			struct
			{
				GLuint holographic_cascade_rays_merge_to_ray_draw_shader_merged_to_ray_texel_x;
				GLuint holographic_cascade_rays_merge_to_ray_draw_shader_merged_to_ray_texel_y;
			};

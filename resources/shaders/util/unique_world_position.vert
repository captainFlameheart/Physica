...
void main()
{
	ivec2 camera_relative_xy = world_position - camera.transform.xy;
	gl_Position = vec4(camera.view_rotation * camera_relative_xy * PROJECTION_SCALE, 0.0, camera.transform.z);

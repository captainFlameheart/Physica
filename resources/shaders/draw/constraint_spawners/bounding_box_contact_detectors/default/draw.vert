...
void main()
{
	...
	uint bounding_box_parent_children_height_index_0 = bounding_box_parent_children_height_base + indices_source_flags.x;
	uint bounding_box_parent_children_height_index_1 = bounding_box_parent_children_height_base + indices_source_flags.y;

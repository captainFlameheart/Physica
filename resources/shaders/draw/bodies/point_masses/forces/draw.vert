void main()
{
	...
	uvec4 write_force_turn_flags = uvec4_data.data[write_force_turn_flags_index];

	uvec2 endpoint_position = position_velocity.xy + position_velocity.zw + write_force_turn_flags.xy * endpoint_index;

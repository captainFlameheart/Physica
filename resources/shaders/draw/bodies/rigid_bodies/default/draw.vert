...
void main()
{
	...
	float angle = float(int(position_flags.z)) * angle_unit_in_radians;
	...
	vec4 camera_offset = vec4(ivec2(position_flags.xy - camera_position.xy), int(-camera_position.z), 1.0f);

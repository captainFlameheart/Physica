...
)
{
	...
	int clamped_near_ray_column_texel_x = min(probe_column, fluence_gathering_data.max_ray_probe_column) * fluence_gathering_data_rays_per_probe;
	...
	int clamped_far_ray_column_texel_x = min(far_ray_column, fluence_gathering_data.max_ray_probe_column) * fluence_gathering_data_rays_per_probe;
